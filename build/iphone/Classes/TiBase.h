...
// in simulator we redefine to format for pageflip Developer console
...
{\
	NSString * exceptionName = [@"org.pageflip." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pageflip";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIpageflipNativeItemNone = -1, 
	UIpageflipNativeItemSpinner = -2,
	UIpageflipNativeItemProgressBar = -3,
	
	UIpageflipNativeItemSlider = -4,
	UIpageflipNativeItemSwitch = -5,
	UIpageflipNativeItemMultiButton = -6,
	UIpageflipNativeItemSegmented = -7,
	
	UIpageflipNativeItemTextView = -8,
	UIpageflipNativeItemTextField = -9,
	UIpageflipNativeItemSearchBar = -10,
	
	UIpageflipNativeItemPicker = -11,
	UIpageflipNativeItemDatePicker = -12,
	
	UIpageflipNativeItemInfoLight = -13,
	UIpageflipNativeItemInfoDark = -14,
	
	UIpageflipNativeItemDisclosure = -15,
	
	UIpageflipNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all pageflip instances of
