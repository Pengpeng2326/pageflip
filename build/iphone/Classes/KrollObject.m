 ...
 * Copyright (c) 2009-2011 by pageflip, Inc. All Rights Reserved.
...
//@interface pageflipObject : NSObject
//@end

@interface pageflipObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[pageflipObject class]])
		{
			for (NSString *key in [[(pageflipObject*)o modules] allKeys])
			{
